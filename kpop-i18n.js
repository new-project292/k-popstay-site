...
(function(){
  ...
  var T = {
    ko: {
      ...
      hero_cta:'2박 3일 무료 신청 (외국인 아미 우선) ›',
      hero_share:'공유',
      ...
      guide2_h3:'포함 사항',
      perk1_title:'안전 검증', perk1_desc:'위홈 플랫폼을 통한 실명 인증 및 안전 심사를 거친 모든 숙소',
      perk2_title:'신뢰할 수 있는 부산 시민', perk2_desc:'자발적으로 집을 공개한 검증된 부산 시민 호스트',
      perk3_title:'보증금 100% 환급', perk3_desc:'체크아웃 시 전액 환급 — 숨겨진 비용 없음',
    ...
    en: {
      ...
      hero_cta:'Apply for Free 2-Night Stay (Global BTS ARMY First) ›',
      hero_share:'Share',
      ...
      guide2_h3:'What\'s Included',
      perk1_title:'Verified Safety', perk1_desc:'Every host is verified through Wehome\'s platform with real identity confirmation and safety screening.',
      perk2_title:'Trustworthy Citizens', perk2_desc:'Hosts are real Busan residents who have volunteered to share their home — community-vetted and accountable.',
      perk3_title:'100% Deposit Refund', perk3_desc:'Your deposit is fully refunded at checkout — no hidden fees, no partial withholding.',
    ...
    ja: {
      ...
      hero_cta:'無料2泊宿泊に申し込む（海外BTSアーミー優先）›',
      hero_share:'シェア',
      ...
      guide2_h3:'含まれるもの',
      perk1_title:'認証された安全性', perk1_desc:'すべてのホストはWehomeのプラットフォームで本人確認と安全審査により認証されています。',
      perk2_title:'信頼できる市民', perk2_desc:'ホストは自宅を共有するために志願した本物の釜山在住者です — コミュニティが審査し、責任を持ちます。',
      perk3_title:'100%デポジット返金', perk3_desc:'チェックアウト時にデポジットが全額返金されます — 隠れた手数料なし、一部差し引きなし。',
    ...
    zh_t: {
      ...
      hero_city:'釜山 — 6月12–14日',
      hero_cta:'申請免費2晚住宿（全球BTS ARMY優先）›',
      hero_share:'分享',
      hero_host:'成為釜山市民房東 ›',
      ...
      guide2_h3:'包含內容',
      perk1_title:'經驗證的安全性', perk1_desc:'每位房東都通過Wehome平台的真實身份確認和安全審查認證。',
      perk2_title:'可信賴的市民', perk2_desc:'房東是自願分享家園的真實釜山居民 — 由社區審查並對其負責。',
      perk3_title:'100%保證金退還', perk3_desc:'結帳時全額退還您的保證金 — 無隱藏費用，無部分扣留。',
    ...
    zh_s: {
      ...
      hero_city:'釜山 — 6月12–14日',
      hero_cta:'申请免费2晚住宿（全球BTS ARMY优先）›',
      hero_share:'分享',
      hero_host:'成为釜山市民房东 ›',
      ...
      guide2_h3:'包含内容',
      perk1_title:'经验证的安全性', perk1_desc:'每位房东都通过Wehome平台的真实身份确认和安全审查认证。',
      perk2_title:'可信赖的市民', perk2_desc:'房东是自愿分享家园的真实釜山居民 — 由社区审查并对其负责。',
      perk3_title:'100%保证金退还', perk3_desc:'退房时全额退还您的保证金 — 无隐藏费用，无部分扣留。',
    ...
    id: {
      ...
      hero_cta:'Daftar Menginap Gratis 2 Malam (Prioritas ARMY BTS Global) ›',
      hero_share:'Bagikan',
      ...
      guide2_h3:'Yang Termasuk',
      perk1_title:'Keamanan Terverifikasi', perk1_desc:'Setiap tuan rumah diverifikasi melalui platform Wehome dengan konfirmasi identitas nyata dan pemeriksaan keamanan.',
      perk2_title:'Warga Terpercaya', perk2_desc:'Tuan rumah adalah warga Busan nyata yang sukarela berbagi rumah mereka — diverifikasi komunitas dan bertanggung jawab.',
      perk3_title:'Pengembalian Deposit 100%', perk3_desc:'Deposit Anda dikembalikan sepenuhnya saat checkout — tidak ada biaya tersembunyi, tidak ada pemotongan parsial.',
